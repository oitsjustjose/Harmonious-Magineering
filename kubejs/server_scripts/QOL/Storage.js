...
ServerEvents.recipes(event => {
  ...
  // Fix chest minecart recipe collision
  event.remove('expandedstorage:wood_chest_minecart');
  event.shapeless('expandedstorage:wood_chest_minecart', ['minecraft:chest_minecart']);
  event.shapeless('minecraft:chest_minecart', ['expandedstorage:wood_chest_minecart']);

  event.remove('expandedstorage:vanilla_wood_mini_chest');
  ...
  event.shaped('expandedstorage:old_wood_chest', ['S', 'C'], {
...
LootJS.modifiers(event => {
  /* Replace vanilla chests with Expanded Storage's */
  event.addEntityLootModifier('aether:mimic').replaceLoot('minecraft:chest', 'expandedstorage:wood_chest');
  event.addBlockLootModifier(/.*/).replaceLoot('minecraft:chest', 'expandedstorage:wood_chest');
  event.addLootTableModifier(/.*/).replaceLoot('minecraft:chest', 'expandedstorage:wood_chest');
});
